...
<body>
  <div class="shell">
    ...
    <footer class="contact-footer">
      ...
      <div class="footer-center"><span data-i18n="success_footer_copy">© 2026 Easy Help Switzerland - all rights reserved.</span><br><a href="privacy.php" style="color:rgba(255,255,255,.45);font-size:12px;text-decoration:none" data-i18n="footer_privacy">Privacy Policy</a></div>
