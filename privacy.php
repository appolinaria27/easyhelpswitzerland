...
<head>
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    header{background:#0a0e14;color:#fff;padding:20px 24px;display:flex;align-items:center;justify-content:space-between}
...
<main>
  ...
  <ul>
    <li><strong>Free consultation form:</strong> name, email address, phone number, current location, and message content.</li>
    <li><strong>Paid booking form:</strong> name, email address, phone number, current location, preferred consultation format, and message content.</li>
    <li><strong>Payment processing:</strong> payment is handled entirely by Stripe. We do not collect or store your card details. We receive confirmation of the payment amount, currency, and status from Stripe.</li>
  </ul>
  ...
  <ul>
    ...
    <li>To record your booking for our internal records.</li>
  </ul>
...
<footer>
  © 2026 Easy Help Switzerland · <a href="privacy.php" style="color:rgba(255,255,255,.5)">Privacy Policy</a>
</footer>
