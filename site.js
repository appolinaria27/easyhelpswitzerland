...
rc_modal_title: "Your current chances",
rc_incomplete_title: "Complete all answers",
rc_incomplete_msg: "Please answer all five questions first, and then we can show your initial route and estimated chances.",
rc_return_btn: "Return to check",
rc_route_job: "Work / Employment Route",
rc_route_study: "Study Route",
rc_route_family: "Family Reunification Route",
rc_route_marriage: "Marriage / Future Family Route",
rc_route_business: "Business / Entrepreneur Route",
rc_route_refugee: "Protection / Refugee Route",
rc_summary_job: "Yes, you may have an option to arrive through a work-related route.",
rc_summary_study: "Yes, studying can be a valid route to come to Switzerland.",
rc_summary_family: "Yes, family reunification may be a relevant route in your case.",
rc_summary_marriage: "Yes, marriage-related residence options may be possible.",
rc_summary_business: "Yes, a business-based route may be possible.",
rc_summary_refugee: "This route cannot be assessed reliably by a simple online tool.",
rc_detail_job: "A job offer is one of the strongest practical grounds, especially if combined with financial means and a stable background.",
rc_detail_study: "This route becomes more realistic when you can show sufficient financial means, a structured study plan, and overall credibility of stay.",
rc_detail_family: "Your chances are usually stronger if there is already a family member in Switzerland and financial / accommodation conditions can be supported.",
rc_detail_marriage: "This route depends heavily on the real family situation, the partner's status in Switzerland and the quality of documentary preparation.",
rc_detail_business: "This option is more individual and usually requires stronger preparation, financial credibility and a more tailored legal review.",
rc_detail_refugee: "Protection-based cases depend on very specific legal and factual circumstances. A private individual review is strongly recommended.",
rc_cta_book: "Book consultation",
rc_cta_consult: "Request private consultation",
rc_chance_strong: "Strong initial chances",
rc_chance_moderate: "Moderate but realistic chances",
rc_chance_low: "Possible, but requires stronger individual review",
rc_why_result: "Why this result:",
rc_finance_yes: "financial means",
rc_finance_no: "limited financial means",
rc_guarantor_yes: "guarantor in Switzerland",
rc_guarantor_no: "no guarantor",
rc_roots_yes: "stable home-country ties",
rc_roots_no: "limited home-country ties",
rc_eu: "EU citizenship",
rc_noneu: "non-EU citizenship",
rc_all_influence: "all influence the initial picture.",
rc_precise: "For a precise answer, your documents, purpose of stay, family status, timeline and canton must be reviewed individually.",

about_kicker: "About",
    about_role: "Relocation Consultant · Zürich",
    ...
    services_side: "We offer support across nine key areas — permits, documents, employment, insurance, tax, banking, daily life, German lessons and consultations.",

    service_tax_title: "Tax & Banking",
    service_tax_desc: "Quellensteuer, bank account opening, AHV guidance and tax support.",
    service_tax_modal_title: "Tax & Banking",
    service_tax_modal_desc: "Support with Swiss tax obligations, bank account opening and pension system guidance.",
    service_tax_modal_item_1: "Quellensteuer explanation & registration",
    service_tax_modal_item_2: "Bank account opening assistance",
    service_tax_modal_item_3: "Simple tax declaration support",
    service_tax_modal_item_4: "AHV / pillar 2 & 3 guidance",
    service_tax_modal_item_5: "Tax number registration",
    service_tax_modal_item_6: "Switch from Quellensteuer to ordinary taxation",
    service_german_title: "German Lessons",
    service_german_desc: "Individual German lessons for daily life, work and permit requirements.",
    service_german_modal_title: "German Lessons",
    service_german_modal_desc: "Practical German lessons tailored for expats — from A1 basics to B1 level required for permits.",
    service_german_modal_item_1: "Single lesson (60 min)",
    service_german_modal_item_2: "Package of 5 lessons",
    service_german_modal_item_3: "Package of 10 lessons",
    service_german_modal_item_4: "B1 level preparation (permit requirement)",
    service_life_title: "Family & Daily Life",
    service_life_desc: "Driving licence, Kita registration, school enrollment and partner support.",
    service_life_modal_title: "Family & Daily Life",
    service_life_modal_desc: "Practical support for settling your family — childcare, schools, driving licence and partner employment.",
    service_life_modal_item_1: "Driving licence conversion support",
    service_life_modal_item_2: "Kita / childcare search & registration",
    service_life_modal_item_3: "School enrollment assistance",
    service_life_modal_item_4: "Spouse / partner employment support",
    service_life_modal_item_5: "Utility setup guidance (internet, electricity)",
    service_life_modal_item_6: "Area & neighbourhood orientation",
...
//Blog.html
  ...
  ai_title: "AI route assistant",
  ai_subtitle: "Quick route guidance, case qualification and WhatsApp handoff.",
  ai_disclaimer: "AI provides general orientation only and does not replace a personal consultation.",
  ...
  blog_insurance_title: "Swiss health insurance: you have exactly 3 months — and the clock starts the day you register",
  blog_insurance_lead: "Switzerland has some of the best healthcare in the world. It also has one of the strictest enrolment rules. You have exactly three months from your official registration date to choose and sign up with a health insurer. Miss this window and the canton assigns you a plan — at a premium you did not choose, often higher than what you would have selected yourself.",
  ...
  sidebar_toc_housing: "Finding an apartment in Zürich",
  sidebar_toc_work: "Working in Switzerland as a foreigner",
  sidebar_toc_family: "Moving to Switzerland with your family",

  blog_housing_meta_category: "Housing",
  blog_housing_meta_time: "5 min read",
  blog_housing_title: "Finding an apartment in Zürich: the real competition and how to stand out",
  blog_housing_lead: "The Swiss rental market — especially in Zürich — is one of the most competitive in Europe. Vacancy rates sit below 0.5%, and a single listing can receive 60 or more applications in the first 48 hours. Knowing how landlords think changes your chances completely.",

  blog_work_meta_category: "Work & Employment",
  blog_work_meta_time: "5 min read",
  blog_work_title: "Working in Switzerland as a foreigner: permits, contracts and what your HR department might not mention",
  blog_work_lead: "Switzerland has one of the highest average salaries in the world. But the path from getting the job to the first payslip involves more steps than most new employees expect — especially if you are coming from outside Switzerland.",

  blog_family_meta_category: "Family & Relocation",
  blog_family_meta_time: "5 min read",
...
`,
  ...
  success_nav_booking: "Booking",
  success_nav_guides: "Guides",
  success_nav_free_consultation: "Free consultation",
  success_nav_contacts: "Contacts",
  success_back: "← Back to homepage",
  success_micro: "Booking confirmed",
  success_hero_title: "Payment <span>successful</span>",
  success_hero_sub: "Your consultation request has been received. Thank you for your booking!",
  success_feature_1: "Payment received",
  success_feature_2: "Booking saved",
  success_feature_3: "Our team notified",
  success_hero_hours: "hours target for follow-up contact",
  success_section_label: "Confirmation",
  success_title: "Thank you for your booking",
  success_subtitle: "Your payment has been confirmed. Check the details of your application. By any issues write us in the contact form. Save the booking data.",
  success_label_name: "Full name",
  success_label_email: "Email",
  success_label_phone: "Phone / WhatsApp",
  success_label_location: "Current location",
  success_label_format: "Preferred format",
  success_label_message: "Short description",
  success_label_session: "Stripe session ID",
  success_label_submitted: "Submitted at",
  success_notice: "Your consultation request has been received successfully. You should now be contacted to confirm the format and next practical steps.",
  success_btn_home: "Back to homepage",
  success_btn_guides: "Read relocation guides",
  success_side_1_label: "Payment status",
  success_side_1_title: "Confirmation received",
  success_step_1: "The payment is now being processed by bank.",
  success_step_2: "We get the payment and prepare to the first call.",
  success_step_3: "You are getting a call from us.",
  success_side_2_label: "Information check",
  success_side_2_title: "What you should remember",
  success_side_2_text: "All the booking and cancellation rules were introduced to you on the previous steps. The wrong bookings due to negligence will be cancelled with the fee. Be sure you get your confirmation per e-mail.",
  success_cta_label: "After booking",
  success_cta_title: "Everything is now being processed",
...
rc_modal_title: "Tus probabilidades actuales",
rc_incomplete_title: "Completa todas las respuestas",
rc_incomplete_msg: "Por favor, responde primero las cinco preguntas para que podamos mostrar tu ruta inicial y las probabilidades estimadas.",
rc_return_btn: "Volver al cuestionario",
rc_route_job: "Ruta laboral / Empleo",
rc_route_study: "Ruta de estudios",
rc_route_family: "Ruta de reagrupación familiar",
rc_route_marriage: "Ruta de matrimonio / Familia futura",
rc_route_business: "Ruta empresarial / Emprendedor",
rc_route_refugee: "Ruta de protección / Refugiado",
rc_summary_job: "Sí, puede que tengas la opción de llegar a través de una ruta laboral.",
rc_summary_study: "Sí, estudiar puede ser una ruta válida para venir a Suiza.",
rc_summary_family: "Sí, la reagrupación familiar puede ser una ruta relevante en tu caso.",
rc_summary_marriage: "Sí, las opciones de residencia por matrimonio pueden ser posibles.",
rc_summary_business: "Sí, una ruta basada en negocios puede ser posible.",
rc_summary_refugee: "Esta ruta no puede evaluarse de manera confiable con una herramienta en línea simple.",
rc_detail_job: "Una oferta de trabajo es uno de los fundamentos prácticos más sólidos, especialmente si se combina con medios económicos y un historial estable.",
rc_detail_study: "Esta ruta se vuelve más realista cuando puedes demostrar medios económicos suficientes, un plan de estudios estructurado y credibilidad general de la estancia.",
rc_detail_family: "Tus probabilidades suelen ser más altas si ya hay un familiar en Suiza y se pueden acreditar condiciones económicas y de alojamiento.",
rc_detail_marriage: "Esta ruta depende en gran medida de la situación familiar real, el estatus del cónyuge en Suiza y la calidad de la preparación documental.",
rc_detail_business: "Esta opción es más individual y generalmente requiere una preparación más sólida, credibilidad financiera y una revisión legal más personalizada.",
rc_detail_refugee: "Los casos de protección dependen de circunstancias legales y fácticas muy específicas. Se recomienda encarecidamente una revisión individual privada.",
rc_cta_book: "Reservar consulta",
rc_cta_consult: "Solicitar consulta privada",
rc_chance_strong: "Probabilidades iniciales sólidas",
rc_chance_moderate: "Probabilidades moderadas pero realistas",
rc_chance_low: "Posible, pero requiere una revisión individual más sólida",
rc_why_result: "Por qué este resultado:",
rc_finance_yes: "medios económicos",
rc_finance_no: "medios económicos limitados",
rc_guarantor_yes: "garante en Suiza",
rc_guarantor_no: "sin garante",
rc_roots_yes: "vínculos estables en el país de origen",
rc_roots_no: "vínculos limitados en el país de origen",
rc_eu: "ciudadanía de la UE",
rc_noneu: "ciudadanía no UE",
rc_all_influence: "influyen en el panorama inicial.",
rc_precise: "Para una respuesta precisa, tus documentos, propósito de estancia, situación familiar, plazos y cantón deben revisarse individualmente.",

about_kicker: "Sobre mí",
    about_role: "Consultora de reubicación · Zúrich",
    ...
    services_side: "Ofrecemos apoyo en nueve áreas clave — permisos, documentos, empleo, seguros, impuestos, banca, vida cotidiana, clases de alemán y consultas.",

    service_tax_title: "Impuestos y banca",
    service_tax_desc: "Quellensteuer, apertura de cuenta bancaria, orientación sobre la AHV y ayuda fiscal.",
    service_tax_modal_title: "Impuestos y banca",
    service_tax_modal_desc: "Apoyo con obligaciones fiscales suizas, apertura de cuenta bancaria y orientación sobre pensiones.",
    service_tax_modal_item_1: "Explicación y registro del Quellensteuer",
    service_tax_modal_item_2: "Ayuda para abrir cuenta bancaria",
    service_tax_modal_item_3: "Apoyo para declaración fiscal simple",
    service_tax_modal_item_4: "Orientación AHV / pilar 2 y 3",
    service_tax_modal_item_5: "Registro del número fiscal",
    service_tax_modal_item_6: "Cambio de Quellensteuer a imposición ordinaria",
    service_german_title: "Clases de alemán",
    service_german_desc: "Clases individuales de alemán para la vida diaria, el trabajo y los permisos.",
    service_german_modal_title: "Clases de alemán",
    service_german_modal_desc: "Clases de alemán prácticas para expatriados — desde nivel A1 hasta B1 requerido para permisos.",
    service_german_modal_item_1: "Clase individual (60 min)",
    service_german_modal_item_2: "Paquete de 5 clases",
    service_german_modal_item_3: "Paquete de 10 clases",
    service_german_modal_item_4: "Preparación nivel B1 (requisito de permiso)",
    service_life_title: "Familia y vida cotidiana",
    service_life_desc: "Carné de conducir, registro en guardería, matriculación escolar y apoyo a la pareja.",
    service_life_modal_title: "Familia y vida cotidiana",
    service_life_modal_desc: "Apoyo práctico para establecer a tu familia — guardería, colegios, carné de conducir y empleo del cónyuge.",
    service_life_modal_item_1: "Apoyo para conversión del carné de conducir",
    service_life_modal_item_2: "Búsqueda y registro en guardería (Kita)",
    service_life_modal_item_3: "Ayuda con la matriculación escolar",
    service_life_modal_item_4: "Apoyo laboral para cónyuge / pareja",
    service_life_modal_item_5: "Orientación para configurar suministros (internet, luz)",
    service_life_modal_item_6: "Orientación sobre barrios y zonas",
...
//Blog.html
  ...
  blog_phone: "+41 76 449 75 81",
  ai_title: "Asistente de ruta IA",
  ai_subtitle: "Orientacion rapida de ruta, evaluacion del caso y contacto por WhatsApp.",
  ai_disclaimer: "La IA proporciona orientacion general y no reemplaza una consulta personal.",
  ...
  blog_insurance_title: "El seguro médico suizo: tienes exactamente 3 meses — y el reloj empieza el día que te registras",
  blog_insurance_lead: "Suiza tiene uno de los mejores sistemas sanitarios del mundo. También tiene una de las normas de inscripción más estrictas. Tienes exactamente tres meses desde tu fecha de registro oficial para elegir y contratar un seguro médico. Si pierdes esta ventana, el cantón te asigna un plan con una prima que no elegiste, a menudo más alta de lo que habrías seleccionado tú mismo.",
  ...
  sidebar_toc_housing: "Encontrar un apartamento en Zúrich",
  sidebar_toc_work: "Trabajar en Suiza como extranjero",
  sidebar_toc_family: "Mudarse a Suiza con tu familia",

  blog_housing_meta_category: "Vivienda",
  blog_housing_meta_time: "5 min de lectura",
  blog_housing_title: "Encontrar un apartamento en Zúrich: la competencia real y cómo destacar",
  blog_housing_lead: "El mercado de alquiler suizo — especialmente en Zúrich — es uno de los más competitivos de Europa. Las tasas de vacancia están por debajo del 0,5%, y un solo anuncio puede recibir 60 o más solicitudes en las primeras 48 horas. Saber cómo piensan los propietarios cambia completamente tus posibilidades.",

  blog_work_meta_category: "Trabajo y empleo",
  blog_work_meta_time: "5 min de lectura",
  blog_work_title: "Trabajar en Suiza como extranjero: permisos, contratos y lo que tu departamento de RRHH podría no mencionar",
  blog_work_lead: "Suiza tiene uno de los salarios medios más altos del mundo. Pero el camino desde conseguir el trabajo hasta el primer sueldo implica más pasos de los que esperan la mayoría de los nuevos empleados — especialmente si vienes de fuera de Suiza.",

  blog_family_meta_category: "Familia y reubicación",
  blog_family_meta_time: "5 min de lectura",
  blog_family_title: "Mudarse a Suiza con tu familia: escuela, registro y los primeros 30 días",
  blog_family_lead: "Reubicarse solo es complejo. Mudarse con pareja e hijos añade varias capas más — cada persona debe registrarse, cada niño debe ser matriculado en la escuela, y el orden de los pasos importa más de lo que la mayoría de las familias se da cuenta.",
...
service_documents_modal_item_8: "Soporte completo de documentos",
  ...
  success_nav_booking: "Reserva",
  success_nav_guides: "Guías",
  success_nav_free_consultation: "Consulta gratuita",
  success_nav_contacts: "Contacto",
  success_back: "← Volver al inicio",
  success_micro: "Reserva confirmada",
  success_hero_title: "Pago <span>exitoso</span>",
  success_hero_sub: "Tu solicitud de consulta ha sido recibida. ¡Gracias por tu reserva!",
  success_feature_1: "Pago recibido",
  success_feature_2: "Reserva guardada",
  success_feature_3: "Equipo notificado",
  success_hero_hours: "horas como objetivo de respuesta",
  success_section_label: "Confirmación",
  success_title: "Gracias por tu reserva",
  success_subtitle: "Tu pago ha sido confirmado. Revisa los detalles de tu solicitud. Ante cualquier problema, escríbenos. Guarda los datos de la reserva.",
  success_label_name: "Nombre completo",
  success_label_email: "Correo electrónico",
  success_label_phone: "Teléfono / WhatsApp",
  success_label_location: "Ubicación actual",
  success_label_format: "Formato preferido",
  success_label_message: "Descripción breve",
  success_label_session: "ID de sesión Stripe",
  success_label_submitted: "Enviado el",
  success_notice: "Tu solicitud de consulta ha sido recibida con éxito. Pronto te contactaremos para confirmar el formato y los próximos pasos.",
  success_btn_home: "Volver al inicio",
  success_btn_guides: "Leer guías de reubicación",
  success_side_1_label: "Estado del pago",
  success_side_1_title: "Confirmación recibida",
  success_step_1: "El banco está procesando el pago.",
  success_step_2: "Recibimos el pago y nos preparamos para la primera llamada.",
  success_step_3: "Te llamaremos pronto.",
  success_side_2_label: "Verificación de información",
  success_side_2_title: "Lo que debes recordar",
  success_side_2_text: "Todas las reglas de reserva y cancelación te fueron presentadas en los pasos anteriores. Las reservas incorrectas por negligencia serán canceladas con cargo. Asegúrate de recibir la confirmación por correo.",
  success_cta_label: "Después de la reserva",
  success_cta_title: "Todo está siendo procesado",
...
rc_modal_title: "Ihre aktuellen Chancen",
rc_incomplete_title: "Alle Antworten vervollständigen",
rc_incomplete_msg: "Bitte beantworten Sie zuerst alle fünf Fragen, damit wir Ihre erste Route und die geschätzten Chancen anzeigen können.",
rc_return_btn: "Zurück zum Check",
rc_route_job: "Arbeits- / Beschäftigungsroute",
rc_route_study: "Studiumsroute",
rc_route_family: "Familienzusammenführungsroute",
rc_route_marriage: "Ehe / Zukünftige Familienroute",
rc_route_business: "Unternehmerroute",
rc_route_refugee: "Schutz- / Flüchtlingsroute",
rc_summary_job: "Ja, Sie haben möglicherweise die Möglichkeit, über eine arbeitsbasierte Route einzureisen.",
rc_summary_study: "Ja, ein Studium kann ein gültiger Weg sein, in die Schweiz zu kommen.",
rc_summary_family: "Ja, Familienzusammenführung kann in Ihrem Fall ein relevanter Weg sein.",
rc_summary_marriage: "Ja, ehebezogene Aufenthaltsoptionen können möglich sein.",
rc_summary_business: "Ja, ein geschäftsbasierter Weg könnte möglich sein.",
rc_summary_refugee: "Diese Route kann mit einem einfachen Online-Tool nicht zuverlässig bewertet werden.",
rc_detail_job: "Ein Jobangebot ist eine der stärksten praktischen Grundlagen, besonders wenn es mit finanziellen Mitteln und einem stabilen Hintergrund kombiniert wird.",
rc_detail_study: "Diese Route wird realistischer, wenn Sie ausreichende finanzielle Mittel, einen strukturierten Studienplan und allgemeine Glaubwürdigkeit des Aufenthalts nachweisen können.",
rc_detail_family: "Ihre Chancen sind in der Regel stärker, wenn bereits ein Familienmitglied in der Schweiz lebt und finanzielle / Unterkunftsbedingungen nachgewiesen werden können.",
rc_detail_marriage: "Diese Route hängt stark von der realen Familiensituation, dem Status des Partners in der Schweiz und der Qualität der Dokumentenvorbereitung ab.",
rc_detail_business: "Diese Option ist individueller und erfordert in der Regel eine stärkere Vorbereitung, finanzielle Glaubwürdigkeit und eine maßgeschneiderte rechtliche Prüfung.",
rc_detail_refugee: "Schutzfälle hängen von sehr spezifischen rechtlichen und tatsächlichen Umständen ab. Eine private Einzelfallprüfung wird dringend empfohlen.",
rc_cta_book: "Beratung buchen",
rc_cta_consult: "Private Beratung anfragen",
rc_chance_strong: "Starke erste Chancen",
rc_chance_moderate: "Moderate, aber realistische Chancen",
rc_chance_low: "Möglich, erfordert aber eine stärkere individuelle Prüfung",
rc_why_result: "Warum dieses Ergebnis:",
rc_finance_yes: "finanzielle Mittel",
rc_finance_no: "begrenzte finanzielle Mittel",
rc_guarantor_yes: "Bürge in der Schweiz",
rc_guarantor_no: "kein Bürge",
rc_roots_yes: "stabile Bindungen im Heimatland",
rc_roots_no: "begrenzte Bindungen im Heimatland",
rc_eu: "EU-Staatsbürgerschaft",
rc_noneu: "Nicht-EU-Staatsbürgerschaft",
rc_all_influence: "beeinflussen das erste Bild.",
rc_precise: "Für eine genaue Antwort müssen Ihre Dokumente, Ihr Aufenthaltszweck, Ihr Familienstand, Ihr Zeitplan und Ihr Kanton individuell geprüft werden.",

about_kicker: "Über mich",
    about_role: "Relocation-Beraterin · Zürich",
    ...
    services_side: "Wir bieten Unterstützung in neun Schlüsselbereichen — Bewilligungen, Dokumente, Beschäftigung, Versicherung, Steuern, Banking, Alltag, Deutschkurse und Beratung.",

    service_tax_title: "Steuern & Banking",
    service_tax_desc: "Quellensteuer, Bankkontoeröffnung, AHV-Beratung und Steuerunterstützung.",
    service_tax_modal_title: "Steuern & Banking",
    service_tax_modal_desc: "Unterstützung bei Schweizer Steuerpflichten, Bankkontoeröffnung und Vorsorgeberatung.",
    service_tax_modal_item_1: "Quellensteuer-Erklärung & Registrierung",
    service_tax_modal_item_2: "Hilfe bei der Bankkontoeröffnung",
    service_tax_modal_item_3: "Einfache Steuererklärung",
    service_tax_modal_item_4: "AHV / Säule 2 & 3 Beratung",
    service_tax_modal_item_5: "Steuernummer-Registrierung",
    service_tax_modal_item_6: "Wechsel von Quellen- zur ordentlichen Besteuerung",
    service_german_title: "Deutschkurse",
    service_german_desc: "Individuelle Deutschkurse für den Alltag, die Arbeit und Bewilligungsanforderungen.",
    service_german_modal_title: "Deutschkurse",
    service_german_modal_desc: "Praktische Deutschkurse für Expats — von A1-Grundlagen bis zum für Bewilligungen erforderlichen B1-Niveau.",
    service_german_modal_item_1: "Einzelstunde (60 Min.)",
    service_german_modal_item_2: "Paket mit 5 Stunden",
    service_german_modal_item_3: "Paket mit 10 Stunden",
    service_german_modal_item_4: "B1-Vorbereitung (Bewilligungsanforderung)",
    service_life_title: "Familie & Alltag",
    service_life_desc: "Führerscheinumschreibung, Kita-Anmeldung, Schuleinschreibung und Partnerunterstützung.",
    service_life_modal_title: "Familie & Alltag",
    service_life_modal_desc: "Praktische Unterstützung für die Eingewöhnung Ihrer Familie — Kita, Schule, Führerschein und Erwerbstätigkeit des Partners.",
    service_life_modal_item_1: "Unterstützung bei der Führerscheinumschreibung",
    service_life_modal_item_2: "Kita-Suche & Anmeldung",
    service_life_modal_item_3: "Schuleinschreibungshilfe",
    service_life_modal_item_4: "Unterstützung für Ehepartner / Partner bei der Jobsuche",
    service_life_modal_item_5: "Hilfe bei Versorger-Einrichtung (Internet, Strom)",
    service_life_modal_item_6: "Quartier- & Umgebungsorientierung",
...
//Blog.html
  ...
  blog_phone: "+41 76 449 75 81",
  ai_title: "KI-Routenassistent",
  ai_subtitle: "Schnelle Routenorientierung, Fallqualifizierung und WhatsApp-Weitergabe.",
  ai_disclaimer: "Die KI bietet nur allgemeine Orientierung und ersetzt keine persoenliche Beratung.",
  ...
  blog_insurance_title: "Schweizer Krankenversicherung: Sie haben genau 3 Monate — und die Uhr beginnt am Tag Ihrer Anmeldung",
  blog_insurance_lead: "Die Schweiz hat eines der besten Gesundheitssysteme der Welt. Sie hat auch eine der strengsten Einschreibungsregeln. Sie haben genau drei Monate ab Ihrem offiziellen Anmeldedatum, um einen Krankenversicherer zu wählen und sich anzumelden. Verpassen Sie dieses Fenster, weist Ihnen der Kanton einen Plan zu — zu einer Prämie, die Sie nicht gewählt haben, oft höher als das, was Sie selbst ausgewählt hätten.",
  ...
  sidebar_toc_housing: "Eine Wohnung in Zürich finden",
  sidebar_toc_work: "Als Ausländer in der Schweiz arbeiten",
  sidebar_toc_family: "Mit der Familie in die Schweiz ziehen",

  blog_housing_meta_category: "Wohnen",
  blog_housing_meta_time: "5 Min. Lesezeit",
  blog_housing_title: "Eine Wohnung in Zürich finden: der echte Wettbewerb und wie man sich abheben kann",
  blog_housing_lead: "Der Schweizer Mietmarkt — insbesondere in Zürich — ist einer der wettbewerbsintensivsten in Europa. Die Leerstandsquote liegt unter 0,5%, und ein einzelnes Inserat kann in den ersten 48 Stunden 60 oder mehr Bewerbungen erhalten. Zu wissen, wie Vermieter denken, verändert Ihre Chancen grundlegend.",

  blog_work_meta_category: "Arbeit und Beschäftigung",
  blog_work_meta_time: "5 Min. Lesezeit",
  blog_work_title: "Als Ausländer in der Schweiz arbeiten: Bewilligungen, Verträge und was Ihre HR-Abteilung möglicherweise nicht erwähnt",
  blog_work_lead: "Die Schweiz hat eines der höchsten Durchschnittsgehälter der Welt. Aber der Weg von der Jobzusage bis zum ersten Gehalt umfasst mehr Schritte als die meisten neuen Mitarbeiter erwarten — besonders wenn Sie aus dem Ausland kommen.",

  blog_family_meta_category: "Familie und Umzug",
  blog_family_meta_time: "5 Min. Lesezeit",
  blog_family_title: "Mit der Familie in die Schweiz ziehen: Schule, Anmeldung und die ersten 30 Tage",
...
service_documents_modal_item_8: "Komplette Dokumentenunterstützung",
  ...
  success_nav_booking: "Buchung",
  success_nav_guides: "Ratgeber",
  success_nav_free_consultation: "Kostenlose Beratung",
  success_nav_contacts: "Kontakt",
  success_back: "← Zurück zur Startseite",
  success_micro: "Buchung bestätigt",
  success_hero_title: "Zahlung <span>erfolgreich</span>",
  success_hero_sub: "Ihre Beratungsanfrage ist eingegangen. Vielen Dank für Ihre Buchung!",
  success_feature_1: "Zahlung eingegangen",
  success_feature_2: "Buchung gespeichert",
  success_feature_3: "Unser Team benachrichtigt",
  success_hero_hours: "Stunden Reaktionsziel",
  success_section_label: "Bestätigung",
  success_title: "Vielen Dank für Ihre Buchung",
  success_subtitle: "Ihre Zahlung wurde bestätigt. Überprüfen Sie die Details Ihrer Anfrage. Bei Fragen kontaktieren Sie uns. Speichern Sie die Buchungsdaten.",
  success_label_name: "Vollständiger Name",
  success_label_email: "E-Mail",
  success_label_phone: "Telefon / WhatsApp",
  success_label_location: "Aktueller Wohnort",
  success_label_format: "Bevorzugtes Format",
  success_label_message: "Kurzbeschreibung",
  success_label_session: "Stripe-Sitzungs-ID",
  success_label_submitted: "Eingereicht am",
  success_notice: "Ihre Beratungsanfrage wurde erfolgreich entgegengenommen. Sie werden in Kürze kontaktiert, um das Format und die nächsten Schritte zu bestätigen.",
  success_btn_home: "Zurück zur Startseite",
  success_btn_guides: "Ratgeber lesen",
  success_side_1_label: "Zahlungsstatus",
  success_side_1_title: "Bestätigung erhalten",
  success_step_1: "Die Zahlung wird derzeit von der Bank verarbeitet.",
  success_step_2: "Wir erhalten die Zahlung und bereiten das erste Gespräch vor.",
  success_step_3: "Sie erhalten einen Anruf von uns.",
  success_side_2_label: "Informationsüberprüfung",
  success_side_2_title: "Was Sie beachten sollten",
  success_side_2_text: "Alle Buchungs- und Stornierungsregeln wurden Ihnen in den vorherigen Schritten mitgeteilt. Fehlerhafte Buchungen aufgrund von Unachtsamkeit werden mit einer Gebühr storniert. Stellen Sie sicher, dass Sie Ihre Bestätigung per E-Mail erhalten.",
  success_cta_label: "Nach der Buchung",
  success_cta_title: "Alles wird nun bearbeitet",
...
rc_modal_title: "Ваші поточні шанси",
rc_incomplete_title: "Дайте відповіді на всі запитання",
rc_incomplete_msg: "Будь ласка, спочатку дайте відповіді на всі п'ять запитань, щоб ми могли показати ваш початковий маршрут і орієнтовні шанси.",
rc_return_btn: "Повернутися до перевірки",
rc_route_job: "Маршрут по роботі / зайнятості",
rc_route_study: "Навчальний маршрут",
rc_route_family: "Маршрут возз'єднання сім'ї",
rc_route_marriage: "Маршрут шлюбу / майбутньої сім'ї",
rc_route_business: "Підприємницький маршрут",
rc_route_refugee: "Маршрут захисту / біженця",
rc_summary_job: "Так, у вас може бути можливість приїхати через трудовий маршрут.",
rc_summary_study: "Так, навчання може бути дійсним маршрутом для приїзду до Швейцарії.",
rc_summary_family: "Так, возз'єднання сім'ї може бути актуальним маршрутом у вашому випадку.",
rc_summary_marriage: "Так, варіанти проживання через шлюб можуть бути можливими.",
rc_summary_business: "Так, бізнес-маршрут може бути можливим.",
rc_summary_refugee: "Цей маршрут не можна надійно оцінити за допомогою простого онлайн-інструменту.",
rc_detail_job: "Пропозиція роботи є однією з найсильніших практичних підстав, особливо в поєднанні з фінансовими засобами та стабільним минулим.",
rc_detail_study: "Цей маршрут стає більш реалістичним, коли ви можете продемонструвати достатні фінансові засоби, структурований план навчання та загальну достовірність перебування.",
rc_detail_family: "Ваші шанси зазвичай вищі, якщо в Швейцарії вже є родич і можуть бути підтверджені фінансові умови та умови проживання.",
rc_detail_marriage: "Цей маршрут значною мірою залежить від реальної сімейної ситуації, статусу партнера в Швейцарії та якості підготовки документів.",
rc_detail_business: "Цей варіант більш індивідуальний і зазвичай вимагає більш ретельної підготовки, фінансової надійності та більш індивідуальної юридичної перевірки.",
rc_detail_refugee: "Справи про захист залежать від дуже специфічних правових і фактичних обставин. Настійно рекомендується індивідуальна приватна перевірка.",
rc_cta_book: "Забронювати консультацію",
rc_cta_consult: "Запросити приватну консультацію",
rc_chance_strong: "Сильні початкові шанси",
rc_chance_moderate: "Помірні, але реалістичні шанси",
rc_chance_low: "Можливо, але потребує більш ретельної індивідуальної перевірки",
rc_why_result: "Чому цей результат:",
rc_finance_yes: "фінансові засоби",
rc_finance_no: "обмежені фінансові засоби",
rc_guarantor_yes: "гарант у Швейцарії",
rc_guarantor_no: "немає гаранта",
rc_roots_yes: "стабільні зв'язки в рідній країні",
rc_roots_no: "обмежені зв'язки в рідній країні",
rc_eu: "громадянство ЄС",
rc_noneu: "громадянство не ЄС",
rc_all_influence: "впливають на початкову картину.",
rc_precise: "Для точної відповіді ваші документи, мета перебування, сімейний стан, терміни та кантон повинні бути перевірені індивідуально.",

about_kicker: "Про мене",
    about_role: "Консультант з релокації · Цюрих",
    ...
    services_side: "Ми пропонуємо підтримку в дев'яти ключових сферах — дозволи, документи, зайнятість, страхування, податки, банкінг, повсякденне життя, уроки німецької та консультації.",

    service_tax_title: "Податки та банкінг",
    service_tax_desc: "Quellensteuer, відкриття рахунку, консультація AHV та податкова підтримка.",
    service_tax_modal_title: "Податки та банкінг",
    service_tax_modal_desc: "Підтримка з швейцарськими податковими зобов'язаннями, відкриттям рахунку та пенсійною системою.",
    service_tax_modal_item_1: "Пояснення та реєстрація Quellensteuer",
    service_tax_modal_item_2: "Допомога з відкриттям банківського рахунку",
    service_tax_modal_item_3: "Підтримка з простою податковою декларацією",
    service_tax_modal_item_4: "Консультація AHV / 2-й та 3-й стовп",
    service_tax_modal_item_5: "Реєстрація податкового номера",
    service_tax_modal_item_6: "Перехід з Quellensteuer на звичайне оподаткування",
    service_german_title: "Уроки німецької",
    service_german_desc: "Індивідуальні уроки для повсякденного життя, роботи та вимог до дозволу.",
    service_german_modal_title: "Уроки німецької",
    service_german_modal_desc: "Практичні уроки німецької для експатів — від рівня A1 до B1, необхідного для дозволів.",
    service_german_modal_item_1: "Одноразовий урок (60 хв)",
    service_german_modal_item_2: "Пакет із 5 уроків",
    service_german_modal_item_3: "Пакет із 10 уроків",
    service_german_modal_item_4: "Підготовка до рівня B1 (вимога для дозволу)",
    service_life_title: "Сім'я та повсякденне життя",
    service_life_desc: "Конвертація прав, реєстрація в Kita, запис до школи та підтримка партнера.",
    service_life_modal_title: "Сім'я та повсякденне життя",
    service_life_modal_desc: "Практична допомога для облаштування сім'ї — дитсадок, школа, права та працевлаштування партнера.",
    service_life_modal_item_1: "Підтримка з конвертацією водійського посвідчення",
    service_life_modal_item_2: "Пошук і реєстрація в Kita / дитсадку",
    service_life_modal_item_3: "Допомога із записом до школи",
    service_life_modal_item_4: "Підтримка працевлаштування чоловіка / дружини",
    service_life_modal_item_5: "Допомога з підключенням послуг (інтернет, електрика)",
    service_life_modal_item_6: "Орієнтація по районах та кварталах",
...
//Blog.html
  ...
  blog_phone: "+41 76 449 75 81",
  ai_title: "AI-асистент маршруту",
  ai_subtitle: "Швидка орієнтація маршруту, кваліфікація справи та зв'язок через WhatsApp.",
  ai_disclaimer: "AI надає лише загальну орієнтацію і не замінює особисту консультацію.",
  ...
  blog_insurance_title: "Швейцарське медичне страхування: у вас рівно 3 місяці — і відлік починається в день реєстрації",
  blog_insurance_lead: "Швейцарія має одну з найкращих систем охорони здоров'я у світі. Вона також має одні з найсуворіших правил реєстрації. У вас рівно три місяці від дати офіційної реєстрації, щоб вибрати та укласти договір зі страховиком. Пропустите це вікно — кантон призначить вам план за тарифом, який ви не обирали, нерідко вищим за той, що ви б обрали самі.",
  ...
  sidebar_toc_housing: "Пошук квартири у Цюриху",
  sidebar_toc_work: "Робота у Швейцарії як іноземець",
  sidebar_toc_family: "Переїзд до Швейцарії з сім'єю",

  blog_housing_meta_category: "Житло",
  blog_housing_meta_time: "5 хв читання",
  blog_housing_title: "Пошук квартири у Цюриху: справжня конкуренція та як виділитися",
  blog_housing_lead: "Швейцарський ринок оренди — особливо у Цюриху — є одним із найконкурентніших у Європі. Рівень вакантності нижче 0,5%, а одне оголошення може отримати 60 і більше заявок за перші 48 годин. Розуміння того, як мислять орендодавці, докорінно змінює ваші шанси.",

  blog_work_meta_category: "Робота і зайнятість",
  blog_work_meta_time: "5 хв читання",
  blog_work_title: "Робота у Швейцарії як іноземець: дозволи, контракти і те, про що ваш HR може не сказати",
  blog_work_lead: "Швейцарія має одну з найвищих середніх зарплат у світі. Але шлях від отримання роботи до першої виплати включає більше кроків, ніж очікує більшість нових працівників — особливо якщо ви приїжджаєте з-за кордону.",

  blog_family_meta_category: "Сім'я і переїзд",
  blog_family_meta_time: "5 хв читання",
  blog_family_title: "Переїзд до Швейцарії з сім'єю: школа, реєстрація та перші 30 днів",
...
service_documents_modal_item_8: "Повний супровід документів",
  ...
  success_nav_booking: "Бронювання",
  success_nav_guides: "Гіди",
  success_nav_free_consultation: "Безкоштовна консультація",
  success_nav_contacts: "Контакти",
  success_back: "← На головну",
  success_micro: "Бронювання підтверджено",
  success_hero_title: "Оплата <span>успішна</span>",
  success_hero_sub: "Ваш запит на консультацію отримано. Дякуємо за бронювання!",
  success_feature_1: "Оплату отримано",
  success_feature_2: "Бронювання збережено",
  success_feature_3: "Команду повідомлено",
  success_hero_hours: "години — ціль для зворотного зв'язку",
  success_section_label: "Підтвердження",
  success_title: "Дякуємо за ваше бронювання",
  success_subtitle: "Вашу оплату підтверджено. Перевірте деталі вашої заявки. У разі питань напишіть нам. Збережіть дані бронювання.",
  success_label_name: "Повне ім'я",
  success_label_email: "Email",
  success_label_phone: "Телефон / WhatsApp",
  success_label_location: "Поточне місцезнаходження",
  success_label_format: "Бажаний формат",
  success_label_message: "Короткий опис",
  success_label_session: "ID сесії Stripe",
  success_label_submitted: "Надіслано",
  success_notice: "Ваш запит на консультацію успішно отримано. Незабаром з вами зв'яжуться для підтвердження формату та наступних кроків.",
  success_btn_home: "На головну",
  success_btn_guides: "Читати гіди з переїзду",
  success_side_1_label: "Статус оплати",
  success_side_1_title: "Підтвердження отримано",
  success_step_1: "Оплата зараз обробляється банком.",
  success_step_2: "Ми отримуємо оплату і готуємось до першого дзвінка.",
  success_step_3: "Ми зателефонуємо вам.",
  success_side_2_label: "Перевірка інформації",
  success_side_2_title: "Що варто пам'ятати",
  success_side_2_text: "Усі правила бронювання та скасування були надані вам на попередніх кроках. Неправильні бронювання через недбалість будуть скасовані з комісією. Переконайтеся, що отримали підтвердження на email.",
  success_cta_label: "Після бронювання",
  success_cta_title: "Усе зараз обробляється",
