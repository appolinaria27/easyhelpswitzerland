...
<head>
  ...
  <title>Request Received — Easy Help Switzerland</title>
  <meta name="description" content="Your free consultation request has been received. We will be in touch within 24 hours." />
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .hero-title span{display:block;font-size:clamp(42px,4.2vw,86px);margin-top:10px}
    .hero-sub{margin-top:20px;font-size:18px;color:rgba(255,255,255,.86);max-width:60ch}
    ...
    .hero-years{display:flex;align-items:flex-start;gap:12px;color:#fff}
    ...
    .title{margin:0 0 14px;font-weight:300;font-size:clamp(38px,4vw,68px);line-height:.95;letter-spacing:-.06em}
    ...
    .cta-band h2{margin:0 0 12px;font-size:clamp(38px,3.8vw,68px);line-height:.95;font-weight:300;letter-spacing:-.06em}
    ...
    @media(max-width:1180px){
      ...
      .hero-center{position:relative;inset:auto;transform:none;display:block;text-align:left;padding-top:120px}
      .hero-bottom{position:relative;left:auto;right:auto;bottom:auto;margin-top:70px;flex-direction:column;align-items:flex-start}
  ...
  <div class="shell">
    <section class="hero-wrap" id="top">
      <div class="hero-top">
        ...
        <div class="hero-right">
          ...
          <a class="back-link" href="free-consultation.php" data-i18n="back">← Back</a>
        </div>
      </div>

      <div class="hero-center">
        <div>
          <div class="micro" data-i18n="consult_success_micro">Request received</div>
          <h1 class="hero-title" data-i18n="consult_success_hero_title" data-i18n-html>Request <span>confirmed</span></h1>
          <div class="hero-sub" data-i18n="consult_success_hero_sub">Your free consultation request has been received. We will get back to you within 24 hours.</div>
        </div>
      </div>

      <div class="hero-bottom">
        <div class="hero-features">
          <div class="hero-feature"><div class="dot">✓</div><div data-i18n="consult_success_feature_1">Request submitted</div></div>
          <div class="hero-feature"><div class="dot">✓</div><div data-i18n="consult_success_feature_2">Confirmation email sent</div></div>
          <div class="hero-feature"><div class="dot">✓</div><div data-i18n="consult_success_feature_3">Team notified</div></div>
        </div>
        <div class="hero-years">
          <strong>24</strong>
          <span data-i18n="consult_success_hero_hours">hours target for follow-up contact</span>
        </div>
      </div>
    </section>
    ...
    <section class="success-zone">
      <div class="success-layout">
        <main class="main-card glass-card">
          <p class="section-label" data-i18n="consult_success_section_label">Confirmation</p>
          <h2 class="title" data-i18n="consult_success_title">Thank you for reaching out</h2>
          <p class="subtitle" data-i18n="consult_success_subtitle">We have received your free consultation request and will be in touch shortly. Check your inbox for a confirmation email.</p>

          <div class="status-box">
            <span class="status-chip"><i></i><span data-i18n="consult_success_status">Request received</span></span>
            <div style="font-size:22px;line-height:1.1;font-weight:500;color:#1a1a2e;" data-i18n="consult_success_type">Free initial consultation</div>
          </div>

          <div class="notice" data-i18n="consult_success_notice">
            We typically respond within 24 hours. If you have an urgent matter, feel free to reach out via WhatsApp.
          </div>

          <div class="btn-row">
            <a class="btn-blue" href="index.html" data-i18n="consult_success_btn_home">Back to homepage</a>
            <a class="btn-outline" href="blog.html" data-i18n="consult_success_btn_guides">Read relocation guides</a>
          </div>
        </main>

        <aside class="sidebar">
          <section class="side-card glass-card">
            <p class="section-label" data-i18n="consult_success_side_1_label">What happens next</p>
            <h3 data-i18n="consult_success_side_1_title">Next steps</h3>
            <div class="step-list">
              <div class="step"><span>01</span><strong data-i18n="consult_success_step_1">We review your request and prepare for your consultation.</strong></div>
              <div class="step"><span>02</span><strong data-i18n="consult_success_step_2">We contact you within 24 hours to arrange a time.</strong></div>
              <div class="step"><span>03</span><strong data-i18n="consult_success_step_3">You receive personalised advice on your situation in Switzerland.</strong></div>
            </div>
          </section>

          <section class="side-card glass-card">
            <p class="section-label" data-i18n="consult_success_side_2_label">Good to know</p>
            <h3 data-i18n="consult_success_side_2_title">Free consultation</h3>
            <p data-i18n="consult_success_side_2_text">The initial consultation is completely free — no commitment needed. We are here to help you understand your options and next steps.</p>
          </section>
        </aside>
      </div>
      ...
      <section class="cta-band glass-card">
        <div>
          <p class="section-label" data-i18n="consult_success_cta_label">Need more help?</p>
          <h2 data-i18n="consult_success_cta_title">We are here for you</h2>
          <p data-i18n="consult_success_cta_text">If you need comprehensive support, you can also book a full paid consultation at any time. We offer permit assistance, relocation support, and document help across Switzerland.</p>
        </div>
        <div class="cta-actions">
          <a href="index.html" class="btn-blue" data-i18n="consult_success_cta_btn_home">Return home</a>
          <a href="booking.php" class="btn-outline" data-i18n="consult_success_cta_btn_book">Book full consultation</a>
        </div>
      </section>
    </section>
    ...
    <footer class="contact-footer">
      <div class="footer-brand">
        ...
        <span data-i18n="brand_name">Easy Help Switzerland</span>
      </div>
      <div class="footer-center">
        <span data-i18n="consult_success_footer_copy">© 2026 Easy Help Switzerland — all rights reserved.</span><br>
      ...
      <div class="footer-right" data-i18n="consult_success_footer_page">Confirmation page</div>
    </footer>
  </div>

  <a class="whatsapp-float" href="https://wa.me/41764497581" target="_blank" rel="noopener" data-i18n-aria-label="wa_label" aria-label="WhatsApp">
