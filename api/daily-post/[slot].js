...
📖 Full guide: https://easyhelpswitzerland.ch/blog/bank-account-switzerland` },
  ...
  { slug: 'cost-of-living', text: `Switzerland is expensive — but most people are surprised by *where* the money actually goes. Knowing this before you arrive changes how you budget.
...
📖 Full guide: https://easyhelpswitzerland.ch/blog/driving-licence-switzerland` },
  ...
  { slug: 'family-reunion', text: `Moving to Switzerland as a family is one of the most complex relocation scenarios — because the rules for your partner and children depend entirely on *your* permit type.
...
Need personalised help? Book a free consultation at easyhelpswitzerland.ch 🇨🇭` },
  ...
  { slug: 'c-permit', text: `The Swiss *C permit* (settlement permit) is the closest thing to permanent residency — and most foreigners don't realise they can already qualify for it.
...
Need personalised help? Book a free consultation at easyhelpswitzerland.ch 🇨🇭` },
  ...
  { slug: 'schools', text: `Switzerland has one of the best public school systems in the world — and it's completely free, including for newcomers. Here's how to navigate enrolment.
...
Need personalised help? Book a free consultation at easyhelpswitzerland.ch 🇨🇭` },
  ...
  { slug: 'transport', text: `Switzerland's public transport system is the most punctual and well-connected in the world. Once you understand how to use it, owning a car in the city becomes optional.
...
Need personalised help? Book a free consultation at easyhelpswitzerland.ch 🇨🇭` },
  ...
  { slug: 'german', text: `You don't need perfect German to live in Switzerland. But you need *enough* — and the fastest way to get there isn't a language school.
...
Need personalised help? Book a free consultation at easyhelpswitzerland.ch 🇨🇭` },
  ...
  { slug: 'emergency', text: `Switzerland is one of the safest countries in the world — but knowing who to call in an emergency before you need it is part of settling in properly.
...
export default async function handler(req, res) {
  ...
  // req.query.slot comes from the URL path segment — always set, never lost
