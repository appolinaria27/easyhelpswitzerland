/**
 * Daily Telegram post for Easy Help Switzerland
 * Triggered by Vercel cron every day at 9:00 AM UTC
 * Test manually: https://easyhelpswitzerland.ch/api/daily-post?secret=YOUR_CRON_SECRET
 */
...
Not sure which permit applies to your situation? That's exactly what the free first consultation is for.
...
New to Switzerland and worried your documents aren't ready yet? We help clients prepare the full application package.
...
*Tip:* Many newcomers open a digital bank account first (Neon/Yuh) to receive their salary, then switch to a traditional bank once their permit is issued.
...
*EU/EEA licence* — relatively simple. Exchange it at the cantonal road traffic office (Strassenverkehrsamt). No test required in most cases. You'll get a Swiss licence in return and your foreign one is sent back to your home country.
...
Your spouse and children under 21 can join you with relatively little friction. They apply for their own B permits and need to register at the Einwohnerkontrolle together with you.

👨‍👩‍👧 *If you hold a B permit (non-EU):*
Family reunion is possible but requires approval. Your salary must meet a minimum threshold (roughly CHF 4,000–5,000 net/month for a family), you need adequate housing, and the application goes through the cantonal migration office.
...
Your Swiss employer submits a work permit application to the cantonal migration authority. They need to prove that no suitable Swiss or EU candidate was available for the role (the "domestic priority" rule). This can take 4–8 weeks.

*Stage 2 — You apply for a visa:*
Once the canton approves the work permit, you apply for a D visa (national visa) at the Swiss embassy in your home country. With visa in hand, you travel to Switzerland and register within 14 days.
...
*Important numbers:*
— Switzerland has annual quotas for non-EU work permits — they're limited
— Certain professions (IT, healthcare, finance) have higher approval rates
— If you're in Switzerland already on a different status, a change of permit is possible but requires a separate process

*The most common mistake:* Assuming you can come first and sort the permit later. For non-EU citizens, the permit must be approved *before* you start working.
...
*Quellensteuer (withholding tax)* — if you're a foreign national without a C permit, your employer deducts tax directly from your salary each month. You don't file a tax return in most cases — but you can request a correction if you have significant deductions (mortgage interest, childcare costs, etc.).
...
*Tip:* Your first Swiss tax bill can arrive 12–18 months after you arrive. Don't be caught off guard — set aside 15–25% of your net salary as a buffer if you're on the full tax return system.
...
⏱ *When can you apply?*
— *EU/EFTA citizens:* after *5 years* of continuous residence in Switzerland
— *Non-EU citizens from certain countries* (USA, Canada, Australia, etc.): after *5 years*
— *Other non-EU citizens:* after *10 years*
— *Spouses of Swiss citizens:* after *5 years* of marriage and living together

📋 *What you need to demonstrate:*
— Continuous residence (no gaps longer than a few months)
— Language skills (usually A2–B1 depending on canton)
— Financial independence (no welfare dependency)
— Integration — some cantons look at community participation, children in local schools, etc.

*The common mistake:* Not applying as soon as you qualify. The C permit doesn't arrive automatically — you must apply at the cantonal migration office. Some people wait years without realising they were already eligible.

If you're approaching your 5th year in Switzerland, let's check your eligibility together.
...
A short-term residence permit for stays *under 12 months*. It's tied directly to a specific employment contract or purpose — it expires when your contract ends.

*Who gets an L permit?*
— Workers on fixed-term contracts under 12 months
— Seasonal workers
— People doing an internship or project-based work
— EU/EFTA citizens coming for a short work placement
...
Need personalised help? Book a free consultation at easyhelpswitzerland.ch 🇨🇭`,
  ...
  {
    slug: 'kvg-deadline',
    text: `You have *90 days* from arriving in Switzerland to choose your health insurance. After that, your canton picks one for you.

Most people know about the deadline. What they don't know is what happens when you miss it — and it's not just about losing your choice.

❌ *If the canton assigns your insurer:*
— You lose the ability to compare premiums — and differences between providers for the same coverage can be CHF 100–200/month
...
— Your date of arrival with a valid permit
...
Here's how to know if your offer is fair.
...
— The *Quellensteuer* rate (withholding tax) takes 15–35% depending on your salary and canton — factor this into your take-home calculation
— Benefits matter: meal allowances, transport, pension contributions, and remote work flexibility are all negotiable

*Rule of thumb:* If your gross salary in Zürich is under CHF 80,000 and you have 3+ years of experience in a professional role, it's worth a conversation.
...
— Bring: passport, registration confirmation, previous school records (translated if needed), and vaccination records
— No entrance exams for primary school — placement is by age and previous schooling

*What newcomers often ask:*
— *Language support:* Most Swiss schools offer German integration classes (DaZ — Deutsch als Zweitsprache) for children who don't speak the local language. Ask about this at enrolment.
...
*Tip:* Register your children at school at the same time as your Anmeldung. Same appointment, same documents.
...
Zürich's ZVV network runs on zones. A single zone subscription covers your local commute. Add zones if you commute to another city. The Halbtax makes long-distance trips on top of this affordable.

*What newcomers miss:*
— SBB (Swiss Federal Railways) app — buy tickets, see live departures, download tickets offline. Essential.
— *Supersaver tickets* — up to 70% off if you book 1–2 weeks in advance for intercity travel
— Night trains and S-Bahn run until 1–2am on weekends — no need for a taxi after a night out in the city

*Practical start:* Buy the Halbtax in your first week. Register at sbb.ch, it's immediate.
...
— *Volkshochschule (VHS)* — cantonal adult education centres. Very affordable (CHF 200–400 per course), structured, and taught in person.
— *Goethe Institut* — more expensive but recognised certificates (A1–C2). Worth it if you need official proof of language level (for C permit or naturalisation).
— *Duolingo + YouTube* — good for vocabulary and listening in the first 2–3 months. Not enough on its own.
...
You can register as self-employed relatively easily. You register with the AHV (social insurance) as self-employed, get your Anmeldung, and you're operating legally. Your B permit covers self-employment.

*For non-EU citizens:*
This is more complex. Your current permit type matters:
— On a B permit tied to an employer: you cannot simply become self-employed without a new permit application
— You need to demonstrate that your self-employment is financially viable and that it serves the Swiss economic interest

📋 *Steps to set up as self-employed (EU/EFTA):*
1. Register your business with the cantonal commercial registry if your revenue exceeds CHF 100,000/year
...
— Below CHF 100,000/year revenue you don't need to register a formal company — you operate as a sole trader (*Einzelunternehmen*)
— AHV contributions as self-employed are *higher* than as an employee — around 10% of income vs 5.3% split with your employer
...
Need personalised help? Book a free consultation at easyhelpswitzerland.ch 🇨🇭`,
  ...
  {
    slug: 'pension',
    text: `Switzerland has one of the most secure pension systems in the world — but as a newcomer, you need to understand it from day one, because the decisions you make now affect your retirement significantly.

🏦 *The three pillars:*

*1st pillar — AHV (state pension):*
Mandatory for everyone in Switzerland. Contributions come automatically from your salary (both you and your employer pay). If you leave Switzerland before retirement, you can claim a *refund* of your contributions — but only under certain conditions.

*2nd pillar — BVG (occupational pension):*
Mandatory if you earn over CHF 22,050/year. Your employer and you both contribute. This money sits in a pension fund and is yours when you retire — or can be withdrawn (partially) when buying property or leaving Switzerland permanently.

*3rd pillar — Private pension (3a):*
Voluntary, but one of the best tax tools in Switzerland. You can deposit up to CHF 7,056/year (2024) and deduct the *entire amount* from your taxable income. That's a real tax saving of CHF 1,500–2,500/year depending on your income and canton.
...
☠️ *Toxicology / Poison control:* 145
🌍 *European emergency number:* 112

🏥 *For non-emergencies:*
— *Medgate / Medi24:* 24/7 medical telephone advice, covered by most Swiss health insurance plans. Call before going to the emergency room — it's often faster and always cheaper.
...
Save these numbers today — before you need them.
