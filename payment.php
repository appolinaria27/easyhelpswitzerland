...
<head>
  ...
  <meta property="og:url" content="https://easyhelpswitzerland.ch/payment.php" />
  ...
  <a class="back-link" href="booking.php" data-i18n="payment_back">← Back</a>
    ...
    <section class="payment-zone">
      <div class="payment-layout">
        ...
        <aside class="sidebar">
          ...
          <section class="info-card glass-card" style="margin-top:16px;">
            <p class="section-label" data-i18n="payment_refund_kicker">Cancellation policy</p>
            <h3 data-i18n="payment_refund_title">Refund &amp; cancellation</h3>
            <p data-i18n="payment_refund_text" style="font-size:13px;line-height:1.6;color:var(--text-muted,#888);margin-top:8px;">You may cancel up to 24 hours before your scheduled consultation for a full refund. Cancellations within 24 hours are non-refundable. If we determine we cannot help with your case, we charge 10% and refund the rest.</p>
          </section>
        </aside>
      </div>
    </section>
    ...
    <footer class="contact-footer">
      ...
      <div class="footer-center">
        <span data-i18n="payment_footer_rights">© 2026 Easy Help Switzerland - all rights reserved.</span><br>
